...
const medic = tabletData.map((option) => {
// console.log('sdfomd'+option.tabletName)
{<option value={JSON.stringify(option.tabletName)}>{option.tabletName}</option> }
}
);
